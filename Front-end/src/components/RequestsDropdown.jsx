    ...
    <div className="fixed inset-0 bg-black/20 z-40" onClick={onClose}>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <h1 id="requests-title" className="text-2xl font-bold text-gray-900 text-center mb-12">
              ...
              <ul className="space-y-4">
                {aanvragenItems.map((item, index) => (
                  <li key={index}>
                    ...
                    >
                       <div className="shrink-0 w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center group-hover:bg-blue-700">
