  ...
  return (
    ...
    <nav className="bg-white border-b border-gray-300 px-12 py-4 flex justify-between items-center gap-8">
      ...
      <ul className="flex gap-10 text-gray-700 font-medium flex-1 ml-8">
        <li>
          <button onClick={() => navigate('/')} className="hover:text-blue-700 transition-colors text-sm bg-none border-none cursor-pointer text-gray-700 font-medium">
            Home
          </button>
        </li>
        <li>
          <a href="/mijn-gemeente" className="hover:text-bllue-700 transition-colors text-sm">
            Mijn Gemeente
          </a>
        </li>
        <li>
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        <button onClick={() => setShowDropdown(true)} className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-md font-semibold flex items-center gap-1 transition-colors text-sm">
